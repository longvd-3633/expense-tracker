...
- Middleware: `app/middleware/auth.ts` để protect routes
...
- Pages: `app/pages/login.vue`, `app/pages/register.vue`, `app/pages/forgot-password.vue`, `app/pages/reset-password.vue`
...
- Store: `app/stores/transactions.ts` với CRUD methods (Supabase client)
...
**Technical Notes:**
- Page: `app/pages/index.vue` (Dashboard)
...
- Utility: `app/utils/csv-export.ts` với PapaParse
...
**Technical Notes:**
- Page: `app/pages/categories/index.vue`
- Store: `app/stores/categories.ts`
...
- Utility: `app/utils/csv-import.ts` với PapaParse
