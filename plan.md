...
```typescript
// Auto-generated by Nuxt from /pages
routes: [
  { path: '/', component: 'pages/index.vue' },              // Dashboard
  { path: '/transactions', component: 'pages/transactions/index.vue' },
  { path: '/settings', component: 'pages/settings.vue' }
]
```
